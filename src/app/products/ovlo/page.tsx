      ...
      >
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-[#EAEAEA]">
            {t.products.ovlo.title}
          </h1>
          <p className="text-xl text-[#A0A0A0] mb-8">
            {t.products.ovlo.subtitle}
          </p>
        ...
        >
          <div className="bg-[#1C1C1C] rounded-2xl p-8">
            {t.products.ovlo.description.map((paragraph, index) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#1C1C1C] rounded-xl p-6">
              <h4 className="text-lg font-semibold text-[#EAEAEA] mb-3">
                {t.products.ovlo.keyFeatures.expiringLinks.title}
              </h4>
              <p className="text-[#A0A0A0]">
                {t.products.ovlo.keyFeatures.expiringLinks.description}
              </p>
            </div>
            
            <div className="bg-[#1C1C1C] rounded-xl p-6">
              <h4 className="text-lg font-semibold text-[#EAEAEA] mb-3">
                {t.products.ovlo.keyFeatures.clickLimits.title}
              </h4>
              <p className="text-[#A0A0A0]">
                {t.products.ovlo.keyFeatures.clickLimits.description}
              </p>
            </div>
            
            <div className="bg-[#1C1C1C] rounded-xl p-6">
              <h4 className="text-lg font-semibold text-[#EAEAEA] mb-3">
                {t.products.ovlo.keyFeatures.smartAnalytics.title}
              </h4>
              <p className="text-[#A0A0A0]">
                {t.products.ovlo.keyFeatures.smartAnalytics.description}
              </p>
            </div>
            
            <div className="bg-[#1C1C1C] rounded-xl p-6">
              <h4 className="text-lg font-semibold text-[#EAEAEA] mb-3">
                {t.products.ovlo.keyFeatures.customBranding.title}
              </h4>
              <p className="text-[#A0A0A0]">
                {t.products.ovlo.keyFeatures.customBranding.description}
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <h3 className="text-2xl font-semibold text-[#EAEAEA] mb-8 text-center">
            {t.products.common.perfectFor}
          </h3>
          
          <div className="space-y-6">
            <div className="bg-[#1C1C1C] rounded-xl p-6">
              <h4 className="text-lg font-semibold text-[#EAEAEA] mb-3">
                {t.products.ovlo.useCases.contentCreators.title}
              </h4>
              <p className="text-[#A0A0A0]">
                {t.products.ovlo.useCases.contentCreators.description}
              </p>
            </div>
            
            <div className="bg-[#1C1C1C] rounded-xl p-6">
              <h4 className="text-lg font-semibold text-[#EAEAEA] mb-3">
                {t.products.ovlo.useCases.professionals.title}
              </h4>
              <p className="text-[#A0A0A0]">
                {t.products.ovlo.useCases.professionals.description}
              </p>
            </div>
            
            <div className="bg-[#1C1C1C] rounded-xl p-6">
              <h4 className="text-lg font-semibold text-[#EAEAEA] mb-3">
                {t.products.ovlo.useCases.eventOrganizers.title}
              </h4>
              <p className="text-[#A0A0A0]">
                {t.products.ovlo.useCases.eventOrganizers.description}
              </p>
            </div>
          </div>
        </motion.div>
