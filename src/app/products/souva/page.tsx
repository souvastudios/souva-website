...
export default function SouvaProduct() {
      ...
      >
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-[#EAEAEA]">
            {t.products.souva.title}
          </h1>
          <p className="text-xl text-[#A0A0A0] mb-8">
            {t.products.souva.subtitle}
          </p>
        ...
        >
          <div className="bg-[#1C1C1C] rounded-2xl p-8">
            {t.products.souva.description.map((paragraph, index) => (
        ...
        >
          <h3 className="text-2xl font-semibold text-[#EAEAEA] mb-8 text-center">
            {t.products.common.howItWorks}
          </h3>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#1C1C1C] rounded-xl p-6">
              <h4 className="text-lg font-semibold text-[#EAEAEA] mb-3">
                {t.products.souva.howItWorks.structuredFormat.title}
              </h4>
              <p className="text-[#A0A0A0]">
                {t.products.souva.howItWorks.structuredFormat.description}
              </p>
            </div>
            
            <div className="bg-[#1C1C1C] rounded-xl p-6">
              <h4 className="text-lg font-semibold text-[#EAEAEA] mb-3">
                {t.products.souva.howItWorks.evidenceBased.title}
              </h4>
              <p className="text-[#A0A0A0]">
                {t.products.souva.howItWorks.evidenceBased.description}
              </p>
            </div>
            
            <div className="bg-[#1C1C1C] rounded-xl p-6">
              <h4 className="text-lg font-semibold text-[#EAEAEA] mb-3">
                {t.products.souva.howItWorks.respectfulModeration.title}
              </h4>
              <p className="text-[#A0A0A0]">
                {t.products.souva.howItWorks.respectfulModeration.description}
              </p>
            </div>
            
            <div className="bg-[#1C1C1C] rounded-xl p-6">
              <h4 className="text-lg font-semibold text-[#EAEAEA] mb-3">
                {t.products.souva.howItWorks.learningFocused.title}
              </h4>
              <p className="text-[#A0A0A0]">
                {t.products.souva.howItWorks.learningFocused.description}
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <h3 className="text-2xl font-semibold text-[#EAEAEA] mb-8 text-center">
            {t.products.common.problemSolving}
          </h3>
          
          <div className="space-y-6">
            <div className="bg-[#1C1C1C] rounded-xl p-6">
              <h4 className="text-lg font-semibold text-[#EAEAEA] mb-3">
                {t.products.souva.problemSolving.echoChambers.title}
              </h4>
              <p className="text-[#A0A0A0]">
                {t.products.souva.problemSolving.echoChambers.description}
              </p>
            </div>
            
            <div className="bg-[#1C1C1C] rounded-xl p-6">
              <h4 className="text-lg font-semibold text-[#EAEAEA] mb-3">
                {t.products.souva.problemSolving.toxicDiscourse.title}
              </h4>
              <p className="text-[#A0A0A0]">
                {t.products.souva.problemSolving.toxicDiscourse.description}
              </p>
            </div>
            
            <div className="bg-[#1C1C1C] rounded-xl p-6">
              <h4 className="text-lg font-semibold text-[#EAEAEA] mb-3">
                {t.products.souva.problemSolving.informationOverload.title}
              </h4>
              <p className="text-[#A0A0A0]">
                {t.products.souva.problemSolving.informationOverload.description}
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            {t.products.common.readManifesto}
